...
router.get("/", (req, res) => {
    const query = () => __awaiter(void 0, void 0, void 0, function* () {
        try {
            let result = yield Event_1.EventModel.find({});
...
router.get("/:id", (req, res) => {
    ...
    if (!id) {
        ...
        const query = () => __awaiter(void 0, void 0, void 0, function* () {
            try {
                let result = yield Event_1.EventModel.findById(id).exec();
                if (!result) {
...
router.post("/", (req, res) => {
    let document = new Event_1.EventModel(req.body);
    const query = () => __awaiter(void 0, void 0, void 0, function* () {
        try {
...
router.delete("/:id", (req, res) => {
    ...
    if (!id) {
        ...
        const query = () => __awaiter(void 0, void 0, void 0, function* () {
            try {
                const result = yield Event_1.EventModel.findByIdAndDelete(id);
                if (!result) {
                    res.status(404).send("Event not foud");
                }
                else {
